...
class STUSB4500:
    ...
    def nvm_dump(self):
        ...
        data = dict(enumerate(sector_data))
        return data
    ...
    def ensure_nvm_custom(self):
        if self.read_rdo().current > 2:
            return
        ...
        # TODO reenable
        # self.nvm_write(nvm_custom)
        print("Flashed PD settings. Rebooting in 5 seconds...")
        # sleep(5)
        # self.reset()
